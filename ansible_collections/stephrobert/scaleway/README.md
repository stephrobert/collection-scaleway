...
[![OpenSSF Scorecard](https://img.shields.io/ossf-scorecard/github.com/stephrobert/collection-scaleway?label=OpenSSF%20Scorecard)](https://github.com/stephrobert/collection-scaleway/blob/0.7.0/docs/scorecard.md)
[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://github.com/stephrobert/collection-scaleway/blob/0.7.0/LICENSE)
...
[docs/guides/dynamic-inventory.md](https://github.com/stephrobert/collection-scaleway/blob/0.7.0/docs/guides/dynamic-inventory.md).
...
|---|---|---|---|
| 0.7.x | 2.17, 2.18, 2.19, 2.20 | >= 3.12 | >= 2.9.0 |
...
* **minor** (`0.8.0`): backward-compatible features and new modules;
