...
DOCUMENTATION = r"""
module: k8s_pool_info
short_description: Gather information about Scaleway Kubernetes pools
version_added: 0.8.0
description:
...
- name: Get a Pool in a Cluster
  stephrobert.scaleway.k8s_pool_info:
    region: fr-par
