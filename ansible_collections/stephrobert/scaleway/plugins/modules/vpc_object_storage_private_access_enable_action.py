...
# Opérations : EnableObjectStoragePrivateAccess
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: vpc_object_storage_private_access_enable_action
short_description: Perform an action on a Scaleway VPC object storage private access
version_added: 0.9.0
description:
...
options:
  ...
  vpc_id:
    description:
    - ID of the VPC for which to enable Object Storage private access. (UUID format)
    type: str
    required: true
  private_network_ids:
    description:
...
- name: Enable
  stephrobert.scaleway.vpc_object_storage_private_access_enable_action:
    region: fr-par
...
MODULE = ActionModule(
    operation=Operation(
        id="EnableObjectStoragePrivateAccess",
        method="POST",
        path="/vpc/v2/regions/{region}/object-storage-private-access/{vpc_id}/enable",
        path_params=("region", "vpc_id"),
        query_params=("private_network_ids",),
    ),
