...
# Opérations : DisableObjectStoragePrivateAccess
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: vpc_object_storage_private_access_disable_action
...
options:
  ...
  vpc_id:
    description:
    - ID of the VPC for which to disable Object Storage private access. (UUID format)
    type: str
    required: true
attributes:
  check_mode:
...
- name: Disable
  stephrobert.scaleway.vpc_object_storage_private_access_disable_action:
    region: fr-par
...
MODULE = ActionModule(
    operation=Operation(
        id="DisableObjectStoragePrivateAccess",
        method="POST",
        path="/vpc/v2/regions/{region}/object-storage-private-access/{vpc_id}/disable",
