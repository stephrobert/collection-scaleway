...
# Opérations : ListClusterAvailableTypes
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: k8s_cluster_available_type_info
short_description: Gather information about Scaleway Kubernetes cluster available types
version_added: 0.8.0
description:
...
- name: List available cluster types for a cluster
  stephrobert.scaleway.k8s_cluster_available_type_info:
    region: fr-par
