...
# Opérations : GetServerCompatibleTypes
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: instance_server_compatible_type_info
short_description: Gather information about Scaleway Instance server compatible types
version_added: 0.1.0
description:
- 'Get compatible commercial types that can be used to update the Instance. The compatibility
  of an Instance offer is based on:
  ...
  * the required scratch storage size
  ...
  If the specified Instance offer is flagged as end of service, the best compatible offer
...
- name: Get Instance compatible types
  local.scaleway.instance_server_compatible_type_info:
    zone: fr-par-1
