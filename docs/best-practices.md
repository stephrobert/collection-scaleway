...
**`contribution`** · MUST · **Met** (URL required)
    ...
    https://github.com/stephrobert/collection-scaleway/blob/0.6.0/CONTRIBUTING.md
...
**`license_location`** · MUST · **Met** (URL required)
    ...
    https://github.com/stephrobert/collection-scaleway/blob/0.6.0/LICENSE
...
**`release_notes`** · MUST · **Met** (URL required)
    ...
    https://github.com/stephrobert/collection-scaleway/blob/0.6.0/ansible_collections/stephrobert/scaleway/CHANGELOG.rst
...
**`report_process`** · MUST · **Met** (URL required)
    ...
    https://github.com/stephrobert/collection-scaleway/blob/0.6.0/CONTRIBUTING.md#issues
...
**`vulnerability_report_process`** · MUST · **Met** (URL required)
    ...
    https://github.com/stephrobert/collection-scaleway/blob/0.6.0/SECURITY.md
...
> 1131 unit tests, plus `ansible-test sanity` on four `ansible-core` versions and
